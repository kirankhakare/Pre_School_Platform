      ...
      <main className="flex-1 ml-72 p-8">
        ...
        <div className="flex gap-4 mb-6">
          <button
            ...
            className={`px-6 py-3 rounded-2xl font-bold text-lg transition-all border-4 border-white shadow-md ${
              activeTab === "students"
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span className={`font-extrabold ${
                          parseInt(student.attendance) >= 90 ? 'text-green-500' : 'text-orange-500'
                        }`}>
                          {student.attendance}
                        </span>
                      </td>
